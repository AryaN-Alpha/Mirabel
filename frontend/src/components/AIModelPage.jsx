...
import { fontHeading, fontMono, text, accent, cyan, success, danger, space, radius, cream, surface, glassBorder, motion } from "./homeTheme";
...
export default function AIModelPage() {
  ...
  return (
    ...
    <div className="flex flex-col" style={{ gap: space[6], maxWidth: 1080, paddingBottom: space[8] * 2.6 }}>
      <PageHeader
        category="INTELLIGENCE ENGINE"
        subsystem={providerLabel.toUpperCase()}
        title="AI Model"
        subtitle="Provider credentials, model routing, reasoning tiers, and token generation parameters."
        badge={
        ...
        <div style={entrance(0.18)}>
          <GlassPanel float={3} delay={-4.1} style={{ padding: `${space[6]}px ${space[6]}px`, height: "100%" }}>
            ...
            <div className="flex items-center gap-2" style={{ marginBottom: space[4] }}>
              <StatusDot color={cred?.configured ? success[400] : "rgba(255,255,255,0.3)"} />
                ...
                {cred?.configured ? (
                  <>
                    ...
                    {cred.masked && (
                      <>
                        {" · "}
                        <span style={{ fontFamily: fontMono, fontSize: 13, color: text.bright }}>{cred.masked}</span>
                      </>
                    )}
                  </>
                ) : (
      ...
      <div style={entrance(0.24)}>
        <GlassPanel float={1} delay={-1.4} glow style={{ padding: `${space[6]}px ${space[7]}px` }}>
          ...
          <div style={{ padding: `${space[4]}px 0`, borderBottom: `1px solid ${glassBorder}` }}>
            <ToggleSwitch
          ...
          <div className="flex items-center flex-wrap" style={{ gap: space[4], marginTop: space[6] }}>
            ...
            <span
              style={{
                ...
                color: dirty ? accent[400] : text.muted,
              }}
            >
