...
export default function CvPreview({ sections }) {
  ...
  return (
    <div className="rounded-2xl shadow-2xl overflow-hidden flex" style={{ minHeight: "70vh", maxHeight: "85vh", overflowY: "auto" }}>
          ...
          <MainSection title="Projects">
            {projects.map((proj) => (
              <div key={proj.id} className="mb-4">
                ...
                {proj.link && (
                  <div className="text-[11.5px]" style={{ color: "#b8926a" }}>
                    {proj.link}
                  </div>
                )}
                {proj.tech && (
