# ⚠️ CRITICAL NON-NEGOTIABLE PRODUCTION RULES FOR GITHUB COPILOT

> **LIVE PRODUCTION SYSTEM WITH 20+ MONTHS OF IRREPLACEABLE DATA**  
> This application is running live in production with sensitive, mission-critical data gathered over 20 months of work. Any data loss or downtime is catastrophic. GitHub Copilot MUST strictly adhere to these 6 rules:
