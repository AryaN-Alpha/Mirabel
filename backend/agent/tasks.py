...
_STEP_DESCRIPTIONS = {
    ...
    "publish_threads_draft": "Getting that Threads post ready to publish…",
    "post_threads_reply": "Getting that Threads reply ready to post…",
    "delete_threads_post": "Getting that Threads post ready to delete…",
    "generate_threads_post": "Drafting a Threads post…",
    "generate_threads_reply": "Drafting a Threads reply…",
